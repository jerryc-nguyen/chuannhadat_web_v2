...
# Usage: ./deploy_v2.sh [tag]
#        ./deploy_v2.sh --restart (to restart services only without rebuilding/pushing)
#        ./deploy_v2.sh --use-current-login [tag] (to use current Docker login instead of deploy token)
