...
import { IUploadedImage } from '@frontend/features/media/image-uploader/types';
import ImageUploader, { convertToUploadedImages } from '@frontend/features/media/image-uploader';
