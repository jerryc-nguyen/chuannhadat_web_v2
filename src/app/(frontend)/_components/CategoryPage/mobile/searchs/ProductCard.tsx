...
import PostDetailMobile from '@app/(frontend)/_components/PostDetail/mobile/post-detail/PostDetailMobile';
import Image from 'next/image';
import AuthorInfo from '@app/(frontend)/_components/PostDetail/mobile/post-detail/components/AuthorInfo';
