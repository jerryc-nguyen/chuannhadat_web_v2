...
const ServicePrice: React.FC<ServicePriceProps> = () => {
  return (
    <section className={cn(vietnam.className, 'mx-auto w-full py-10 text-lg md:w-4/5')}>
      <h1 className="mb-10 text-5xl font-bold">Bảng giá dịch vụ</h1>
      <section className="pb-4">
        <h2 className="mb-2 mt-4 text-2xl font-bold">Gói combo cho môi giới</h2>
        <p>Gói COMBO tiết kiệm chi phí đăng tin VIP cho môi giới.</p>
        <p>Giúp bạn linh hoạt và dễ dàng thay đổi loại tin vip cho các tin đã đăng</p>
      ...
      <section>
        ...
        <p>Gói làm mới tin đăng giúp bạn tiết kiệm thời gian và đẩy tin lên top</p>
        <Link
          href={'#'}
          className="text-primary_color/80 transition-all hover:text-primary_color hover:underline"
        >
          Xem hướng dẫn cài đặt tự động làm mới tin giúp bạn tiết kiệm thời gian
        </Link>
        <section className="mt-4 flex flex-col gap-x-4 gap-y-4 lg:flex-row">
          <CardPackage
