...
export default function Desktop() {
  ...
  return (
    <div className="bg-bg-primary isolate mx-auto flex max-w-[3840px] flex-col">
      <main className="flex grow flex-col">
        <div className="min-720:[--container-x-padding:24px] min-1280:[--container-x-padding:32px] min-1536:[--container-x-padding:80px] [--container-x-padding:20px]">
          <div className="bg-bg-primary isolate flex max-w-[3840px] flex-col">
            <header className="sticky top-0 z-10">
              <nav className="border-divider-primary bg-bg-primary min-840:border-0 border-b">
                <div className="px-container-x-padding min-720:gap-x-12 min-840:grid-cols-[1fr_minmax(auto,520px)_1fr] min-840:grid-rows-1 min-840:py-4 grid w-full grid-cols-[min-content_auto_min-content] grid-rows-[1fr_auto] items-center gap-x-8">
                  <MainNav></MainNav>
                </div>
              </nav>
            </header>
