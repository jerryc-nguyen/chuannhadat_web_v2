...
const PaymentDialog: React.FC<PaymentDialogProps> = ({ plan, onBuy, isLoading }) => {
  return (
    <div className='w-full'>
        ...
        <Button variant="default" className='w-full mt-4' onClick={() => onBuy(plan.plan_id)} disabled={isLoading}>
