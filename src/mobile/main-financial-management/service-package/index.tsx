...
const ServicePackageView = () => {
  ...
  return (
    <div>
      ...
      <a href="https://chuannhadat.com/huong-dan-tu-dong-lam-moi" target="_blank" rel="noopener noreferrer" className='text-[#007bff] my-4'>
        Xem hướng dẫn cài đặt tự động làm mới tin giúp bạn tiết kiệm thời gian
      </a>
      <br />
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
