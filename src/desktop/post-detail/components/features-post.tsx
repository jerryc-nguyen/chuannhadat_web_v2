    ...
    <div className="flex flex-col gap-y-2">
      {data?.full_address && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Địa chỉ</span>
      ...
      {data?.formatted_price_per_m2 && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Giá / m2</span>
          <span className="text-sm text-secondary">{data?.formatted_price_per_m2}</span>
        </div>
      )}
      {data?.bedrooms_count && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Số phòng ngủ</span>
      ...
      {data?.bathrooms_count && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Số phòng tắm</span>
          <span className="text-md text-secondary">{data?.bathrooms_count}</span>
        </div>
      )}
      {data?.floors_count && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Số tầng</span>
      ...
      {data?.phap_ly && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Pháp lý</span>
      ...
      {data?.formatted_publish_at && (
        <div className="flex gap-1">
          <span className="min-w-[8rem] text-sm font-semibold text-secondary">Ngày đăng</span>
