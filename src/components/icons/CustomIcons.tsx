 ...
 * Branded icons that are not available in lucide-react
 */
...
// Heart Outline Icon - Replaces PiHeart
...
// Heart Filled Icon - Replaces PiHeartFill
export const HeartFilled: React.FC<IconProps> = ({ className, size = 24, color = "currentColor" }) => (
  <svg
    className={className}
    width={size}
    height={size}
