...
const ListItem = forwardRef((props: A, ref: A) => {
  const {
    component = 'li',
    colors: colorsProp,
    className,
  ...
  const dividers = dividersProp ?? true;
  const theme = 'ios';
  ...
  const hrefComputed =
    href === true || href === false || typeof href === 'undefined' ? undefined : href || '';
  const ItemContentComponent = isLink ? linkComponent : isLabel ? 'label' : 'div';
  const linkPropsComputed = isLink ? { href: hrefComputed, target, ...linkProps } : {};
  ...
  return (
    <Component ref={elRef} className={c.base} {...attrs}>
      <ItemContentComponent ref={rippleElRef} className={itemContentClasses} {...linkPropsComputed}>
